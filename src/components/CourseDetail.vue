    ...
    <div id="course_list_id" style="background: white;width: 100%;height: 100%;min-height: 1000px;">
        ...
        <div class="container" style="padding-top: 100px;">
            ...
            <div class="course-detail-class border-shadow-set">
                <div id="course_detail_top_part_id">
                    ...
                    <div id="course_detail_top_right_part_id" class="course-detail-coursename-div-class">
                        <div id="course_detail_top_right_coursename_part_id" style="background: rgb(16,72,131);height: 100px;width: 100%;">
                            <br />
                            <span style="margin-left: 15%;color: white;font-size: 2em;margin-top: 50px;">“ {{courseInfo.name}} ”</span><br />
                            <span style="margin-left: 18%;color: white;font-size: 1em;">欧洲华商商学院&nbsp; 第{{period}}期</span>
                        </div>
                        <div id="course_detail_top_right_courseinfo_part_id" style="margin-top: 1%;height: 200px;">
                            <div><span style="font-size: 2em;margin-left: 2%;">{{courseInfo.employer}}{{courseInfo.realname}}{{courseInfo.academic}}</span></div>
                            <div style="margin-top: 10px;"><span style="font-size: 1.2em;margin-left: 2%;">开课时间：{{courseInfo.totalbegin}}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;结束时间：{{courseInfo.totalend}}</span></div>
                            <div style="margin-top: 10px;"><span style="font-size: 1.2em;margin-left: 2%;">课程地点及具体时间</span></div>
                            <div id="" style="font-size: 1.2em;margin-top: 10px;">
                                <div style="float: left;width: 23%;background: #;height: 100px;padding-left: 2%;" v-for="item in courseInfo.courses">
                                    <p style="border-top: 2px solid rgb(16,72,131);"><b>{{item.codeflagname}}:</b>{{item.room}}</p>
                ...
                <div id="course_detail_bottom_part_id" style="border: 4px solid rgb(16,72,131);border-top: none;padding: 1em;">
                    <span style="border-bottom: 2px solid rgb(16,72,131);font-size: 1.5em;">课程内容</span>
                    <div id="" style="text-indent: 20px;margin-top: 20px;">
            ...
            <div class="border-shadow-set" style="margin-top: 20px;padding: 20px;margin-bottom: 20px;">
                <div style="min-height: 9em;position: relative;">
