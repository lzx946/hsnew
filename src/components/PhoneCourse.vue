                    ...
                    <div class="col-sm-12 col-md-12" style="background: white;height: 400px;margin-bottom: 50px;padding: 0;overflow: hidden;" v-for="(item,index) in CourseList">
                        ...
                        <div v-if="index%2==0">
                            ...
                            <div id="" style="text-align: center;width: 100%;position: absolute;margin-top: 40px;margin-left: 100px;">
                                <router-link :to="{name:'PhoneCourseDetail',params:{id:item.id}}"><span style="display: block;font-size: 2.8em;font-family: '黑体';color: black;">{{item.name}}</span></router-link>
                        ...
                        <!--expert img-->
                        <div id="">
                            <img v-if="index%2==0" :src="item.url" class="expert-img-class-left" />
                            <img v-else :src="item.url" class="expert-img-class-right" />
                        </div>
                        <!--course info right-->
                            ...
                            <div style="font-size: 1.5em;font-weight: 600;margin-top: 20px;position: relative;height: 1.8em;">
                                ...
                                <div class="right-course-div-enlist">
                                    <div style="transform: skew(30deg, 0);position: relative;">
                                        ...
                                        <div style="color: white;font-size: 0.7em;text-align: center;line-height: 35px;" @click="shareEnter()">
                                            <span style="cursor: pointer;line-height: 35px;">分享报名</span>
                                        </div>-->
                                    </div>
                                </div>
                            </div>
                        ...
                        <div v-else class="left-course-div">
                            ...
                            <div style="font-size: 1.5em;font-weight: 600;margin-top: 20px;position: relative;height: 1.8em;">
                                ...
                                <div class="left-course-div-enlist">
                                    <div style="transform: skew(-30deg, 0);position: relative;">
                                        <!--<div class="left-course-div-enlist-share" @click="shareEnter()">
                                            <span style="cursor: pointer;line-height: 35px;">分享报名</span>
                                        </div>
                                        <div class="left-course-div-enlist-line"></div>
                                        <span class="left-course-div-enlist-quit" @click="showBackEnterF(item.courses)">退报名</span>-->
                                    </div>
                                </div>
