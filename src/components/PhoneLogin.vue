    ...
    <div id="login_id">
        ...
        <div class="container" style="padding-top: 100px;min-height: 900px;color: black;">
            <form class="form-signin" novalidate>
                <a><img src="http://www.ecebs.eu/static/img/logo.a90001e.png" height="80px" style="margin-left: 95px;display: block; " /></a>
                ...
                <div style="float: left;">
                    ...
                    <router-link class="btn btn-lg btn-info" style="width: 105px; border-radius: 0;background: rgb(16,72,131);border: none;" :to="{ name: 'PhoneRegister'}"><span>注册</span></router-link>
                </div>
            </form>
        </div>
    </div>
