<template>
    <div id="login_id">
        ...
        <div style="overflow: hidden;margin-top: 80px;">
            <!-- left menu -->
            <div style="width:12em;float: left;position: fixed;left: 0;padding-top: 30px;">
                <div class="tsama-info-left-menu" v-on:click="getInfo(0)" :class="{'tsama-info-left-menu-active':active==0}">
                    ...
                    <span style="margin-top: -100px;">个人信息</span>
                </div>
            </div>
            <!-- right content -->
            <div style="background: #ECECEC;width: 100%;height: 100%;margin-left: 12em;min-height: 1280px;padding: 0.1em 1em; padding-bottom: 20em;">
                ...
                <div style="margin-top: 50px;">
                    ...
                    <div><img :src="imgUrl" style="height: 200px;width:155px;margin-left: 50px;float: left;" alt="暂无背景图片，请上传" /></div>
                    <div><img :src="imgUrl" style="height: 8em;width:8em;margin-left: 50px; border-radius: 50%;border: 2px solid white;margin-top: 44px;" alt="暂无头像图片，请上传" />
                    </div>
                    <div style="clear: left;margin-left: 10.6em;margin-top: 3.5em;">
                ...
                <div style="margin-top: 50px;">
                    ...
                    <div style="padding: 1em;position: relative;">
                        ...
                        <input type="text" v-on:blur="toBlur(4)" v-on:focus="toFocus(4)" id="inputMainPoster" class="form-control" style="width: 300px;margin-left: 110px;" v-model="title" placeholder="请输入您的职位">
                        <transition name="fade">
