<template>
    <div id="expert_list_id" style="background: #CCCCCC;width: 100%;height: 100%;min-height: 1000px;">
        <!--====遮罩层、加载中===-->
                    ...
                    <div class="col-sm-6 col-md-4" v-for="(item,index) in NewsList">
                        <div class="thumbnail border-shadow-set" style="overflow: hidden;border: 0;">
                            <div style="overflow: hidden;">
                                <router-link :to="{name:'WeixinPhoneNewsDetail',params: {id:item.id}}"><img :src="defalutNewsImg(item.url)" class="photo-img-size"></router-link>
                            </div>
